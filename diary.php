...
<?php include("header.php"); ?>
			<div id="content">
				...
				<p class="centre"><strong>Schedule for the week 29th May to 5th June</strong></p>
				...
				<table class="styled" summary="Schedule for events in the coming week(s)">
					...
					<tbody>
						<tr class="odd">
							...
							<td>1 Thessalonians 4:1-5:11 - <br />"Living and Waiting for the Lord"</td>
						</tr>
						<tr>
						...
						<tr class="odd">
							...
							<td>Both services will be led by Rev. Paul Carter<br />Evening worship includes communion</td>
						</tr>
					</tbody>
				</table>
			</div>
