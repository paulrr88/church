...
<?php include("header.php"); ?>
			<div id="content">
				...
				<p class="centre"><strong>Schedule for the week 1st to 8th October</strong></p>
				...
				<table class="styled" summary="Schedule for events in the coming week(s)">
					...
					<tbody>
						<tr class="odd">
							...
							<td>Women's Fellowship:<br />Miss Pam Evans<br />(Harvest Praise)</td>
							<td></td>
						</tr>
						<tr>
                        ...
                        <tr>
							...
							<td><strong>Women's Breakfast</strong>:<br />Joslyn Arnold</td>
							<td>(Ticket-holders only)</td>
                        </tr>
						<tr class="odd">
							<th scope="row">Sunday<br />10:30 A.M.</th>
							<td>Sunday Service</td>
                            <td><strong>SEBA Celebration at Brighton 6:00 P.M.,<br /> no service here</strong></td>
						</tr>
					</tbody>
				</table>
			</div>
