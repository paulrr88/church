...
<?php include("header.php"); ?>
			<div id="content">
				...
				<p class="centre"><strong>Schedule for the week 14th to 21st January</strong></p>
				...
				<table class="styled" summary="Schedule for events in the coming week(s)">
					...
					<tbody>
                        ...
                        <tr class="odd">
							...
							<td><strong>Open Church Meeting</strong></td>
							<td>Important meeting for members<br />
                                and congregation!<br />
                                <a href="newssheet.php">See newssheet</a> for details</td>
						</tr>
						<tr>
